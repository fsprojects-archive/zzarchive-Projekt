...
let githubLink = "http://github.com/fsprojects/projekt"

// Specify more information about your project
let info =
  [ "project-name", "Projekt"
    "project-author", "Karl Nilsson and Robin Neatherway"
    "project-summary", "A command line tool for creating and updating F# project files"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Projekt" ]
