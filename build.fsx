...
let summary = "A command line tool for creating and updating F# project files"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "A command line tool for creating and updating F# project files"

// List of author names (for NuGet package)
let authors = [ "Karl Nilsson and Robin Neatherway" ]

// Tags for your project (for NuGet package)
let tags = "f# build"

// File system information 
let solutionFile  = "Projekt.sln"
