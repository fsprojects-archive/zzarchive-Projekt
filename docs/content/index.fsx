...
<div class="row">
  ...
  <div class="span6">
    <div class="well well-small" id="nuget">
      The Projekt library can be <a href="https://nuget.org/packages/Projekt">installed from NuGet</a>:
      <pre>PM> Install-Package Projekt</pre>
    </div>
  </div>
  <div class="span1"></div>
</div>
...
[License file][license] in the GitHub repository. 
  ...
  [license]: https://github.com/fsprojects/Projekt/blob/master/LICENSE.txt
*)
